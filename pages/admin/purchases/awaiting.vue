      ...
      <template v-slot:default>
        <thead>
          <tr>
            ...
            <th class="text-left">View Information</th>
...
export default {
  ...
  methods: {
    ...mapActions({
      getAwaitingPurchases: "purchases/getAwaitingPurchases",
      countTotalPurchases: "purchases/countTotalAwaitingPurchases",
    }),
    viewOrder(id) {
      this.$store
      ...
      this.$store
        ...
        .then((response) => {
          if (response.data.success) {
            ...
            this.getAwaitingPurchases(this.page);
